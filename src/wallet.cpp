...
// KAT: total coins staked (non-spendable until maturity)
...
// KAT: check 'spent' consistency between wallet and txindex
// KAT: fix wallet spent state according to txindex
...
// KAT: disable transaction (only for coinstake)
